...
# vatType ברמת המסמך.
# לעסק פטור ממע"מ (עמותה / עוסק פטור) יש לבחור 0 — המע"מ יוצא 0 ממילא לפי הגדרת העסק.
# הערך 2 נדחה ע"י ה-API עבור עסק פטור (errorCode 2409, "סוג מע\"מ לא תקין").
DOC_VAT_TYPES = {
    0: "ברירת מחדל לפי הגדרת העסק",
    1: "פטור ממע\"מ",
    2: "מעורב (לא נתמך לעסק פטור)",
}
